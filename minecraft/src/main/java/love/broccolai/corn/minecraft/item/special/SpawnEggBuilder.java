...
public final class SpawnEggBuilder extends AbstractItemBuilder<SpawnEggBuilder, SpawnEggMeta> {
     ...
     */
    public static SpawnEggBuilder spawnEggBuilder(final ItemStack itemStack) throws IllegalArgumentException {
     ...
     */
    public static SpawnEggBuilder spawnEggBuilder(final Material material) throws IllegalArgumentException {
